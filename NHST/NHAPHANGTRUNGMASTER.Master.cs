...
namespace NHST
{
    public partial class NHAPHANGTRUNGMASTER : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrAddHCM.Text = "<p>" + confi.Address2 + "</p>";
                ...
                string infocontent = confi.AboutText;
            ...
            else
            {
                ...
                ltrLogin.Text += "<li><img src=\"/App_Themes/CSSDAIAN/images/user-login.png\" alt=\"\">";
