<%@ Page  Title="Danh sách phiếu in" MasterPageFile="~/UserNhapHangTrungMaster.Master" Language="C#" AutoEventWireup="true" CodeBehind="user-outstock-payment.aspx.cs" Inherits="NHST.user_outstock_payment" %>
            ...
            <div class="list-staff col s12 section">
                ...
                <div class="list-table card-panel" style="margin-top: 20px">
                    <div class="center-f" style="text-align: center">
                         <h4 class="title no-margin" style="font-weight: bold; text-transform:uppercase">In phiếu</h4>
                    </div>
