                ...
                <div class="container">
                    <div id="login-page" class="row">
                        <div class="col s12 m8 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                            ...
                            <div class="row">
                                <div class="input-field col s12 align-center">
                                    <span class="img logo-login">
                                       <a href="/">
                                            <img src="/App_Themes/NHAPHANGTRUNG/images/logo.png" alt="logo"></a></span>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6">
                                    ...
                                    <span class="helper-text">
                                        <asp:RegularExpressionValidator
                                            ...
                                            ValidationExpression="^(?=.*[A-Za-z])(?=.*\d).{8,}$" ValidationGroup="Group" />
                                    </span>
                                </div>
                                <div class="input-field col s12 m6">
                                    <i class="material-icons prefix ">lock_outline</i>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <a class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12" href="javascript:;" onclick="register()" style="background: #fdba24 !important;">Đăng ký</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
