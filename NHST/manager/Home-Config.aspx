    ...
    <div id="modalEditQuest" class="modal modal-fixed-footer">
        ...
        <div class="modal-bd">
            <div class="row">
                ...
                <div class="input-field col s12">
                    <asp:TextBox runat="server" ID="txtContentQuest" placeholder="" type="text" class="validate" TextMode="MultiLine"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    <asp:ListBox runat="server" name="" ID="ddlEditBenefitType">
                        <asp:ListItem Value="2">Cam kết của chúng tôi</asp:ListItem>
                        <asp:ListItem Value="1">Quyền lợi khách hàng</asp:ListItem>
                    </asp:ListBox>
                    <label>Loại</label>
                </div>
                <div class="input-field col s12">
