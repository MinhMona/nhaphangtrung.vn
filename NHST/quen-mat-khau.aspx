                        ...
                        <form runat="server" class="login-form">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <a style="background: #fdba24 !important;" onclick="GetPass()" class="btn waves-effect waves-light border-round bg-dark-gradient col s12 mb-1">Khôi phục mật khẩu</a>
                                </div>
                            </div>
                            <div class="row">
